 ...
 * </pre>
 */
public class YYShadowLayout extends FrameLayout {
    ...
    public YYShadowLayout(Context context) {
        super(context);
        initView(context, null);
    }

    public YYShadowLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public YYShadowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        TypedArray attr = getTypedArray(context, attrs, R.styleable.YYShadowLayout);
        if (attr == null) {
            return;
        }
        ...
        try {
            //默认是显示
            leftShow = attr.getBoolean(R.styleable.YYShadowLayout_yc_leftShow, true);
            rightShow = attr.getBoolean(R.styleable.YYShadowLayout_yc_rightShow, true);
            bottomShow = attr.getBoolean(R.styleable.YYShadowLayout_yc_bottomShow, true);
            topShow = attr.getBoolean(R.styleable.YYShadowLayout_yc_topShow, true);

            mCornerRadius = attr.getDimension(R.styleable.YYShadowLayout_yc_cornerRadius, 0);
            mShadowLimit = attr.getDimension(R.styleable.YYShadowLayout_yc_shadowLimit, 0);
            mDx = attr.getDimension(R.styleable.YYShadowLayout_yc_dx, 0);
            mDy = attr.getDimension(R.styleable.YYShadowLayout_yc_dy, 0);
            mShadowColor = attr.getColor(R.styleable.YYShadowLayout_yc_shadowColor,
