package com.hewking.develop.demo.photo
...
class ActivityResultLauncherCompat<I, O> constructor(
    ...
    constructor(caller: ActivityResultCaller, activity: FragmentActivity, contract: ActivityResultContract<I, O>) :
            this(caller, contract, activity)
